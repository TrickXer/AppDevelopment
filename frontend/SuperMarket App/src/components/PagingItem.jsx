            ...
            <Table sx={{ p: '0px 16px 0px 16px', borderCollapse: 'separate', borderSpacing: '0px 10px', tableLayout: 'fixed', overflow: 'hidden' }}>
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell align='center' sx={{ color: '#9E9EA2', borderBottom: 'none' }}>Item</TableCell>
                        <TableCell align='center' sx={{ color: '#9E9EA2', borderBottom: 'none' }}>Quantity</TableCell>
                                ...
                                <TableBody>
                                    {
                                        order.items.map((item, indx) => (
                                            ...
                                            >
                                                ...
                                                <TableCell align='left' sx={{ borderBottom: 'none', display: 'flex', gap: '1em', alignItems: 'center' }}>
